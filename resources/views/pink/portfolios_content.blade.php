                ...
                <div class="general-pagination group">
                    @if($portfolios->lastPage() > 1)
                        @if($portfolios->currentPage() !== 1)
                            <a href="{{$portfolios->url($portfolios->currentPage() - 1)}}" class="">{{Lang::get('pagination.previous')}}</a>
                        @endif
                        ...
                        @if($portfolios->currentPage() !== $portfolios->lastPage())
                            <a href="{{$portfolios->url($portfolios->currentPage() + 1)}}" class="">{{Lang::get('pagination.next')}}</a>
                        @endif
